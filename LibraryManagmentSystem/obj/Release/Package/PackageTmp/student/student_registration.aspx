<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_registration.aspx.cs" Inherits="LibraryManagmentSystem.student.student_registration" %>
...
<body class="bg-dark">
                ...
                <div class="login-form">
                    <form id="form1" runat="server">
                        ...
                        <div class="form-group">
                           ...
                           <asp:TextBox ID="username" runat="server" class="form-control" placeholder="Userename"></asp:TextBox>
                        </div>
    ...
    <script type="text/javascript">
        var your_site_key = '6LcVJvcUAAAAALYVoggGELjEVt2rPndPncD0PDF0';
        var renderRecaptcha = function () {
            grecaptcha.render('ReCaptchContainer', {
                'sitekey': '6LcVJvcUAAAAALYVoggGELjEVt2rPndPncD0PDF0',
